...
export default function Cravings() {
  const project = projectsData.find((p) => p.id === "cravings");
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center pb-12 sm:pb-16 border-b border-slate-200/80">
        ...
        <div className="lg:col-span-6">
          <div className="relative rounded-3xl p-2 sm:p-4 bg-gradient-to-tr from-rose-100/40 via-amber-50/40 to-teal-50/40 border border-slate-200/80 shadow-lg">
            <ProjectMockup projectId="cravings" variant="dual" />
          </div>
        </div>
      </div>
      ...
      <div className="py-12 sm:py-16 space-y-16">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500">
                Key milestones built and deployed in the Cravings platform
              </p>
            </div>
          </div>
        ...
        <div>
          <div className="max-w-2xl mb-6">
            ...
            <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-1">
              End-to-End MERN Architecture & Integrations
            </h2>
            <p className="text-sm text-slate-600 mt-2">
              Clean separation across the React.js client, protected Express REST endpoints, MongoDB database, and external Razorpay/Cloudinary/Google Maps integrations.
            </p>
          </div>

          <ArchitectureDiagram type="cravings" />
        </div>
        ...
        <div className="pt-8 border-t border-slate-200 flex flex-wrap items-center justify-between gap-4">
          ...
          <Link
            to="/projects/verdantx"
            className="inline-flex items-center gap-2 text-sm font-semibold text-teal-700 hover:text-teal-800 bg-teal-50 border border-teal-200 px-4 py-2 rounded-full"
          >
            <span>Next Project: VerdantX</span>
            <span>→</span>
          </Link>
        </div>
      </div>
